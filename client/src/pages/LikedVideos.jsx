...
function LikedVideos() {
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        const res = await axios.get(`${serverUrl}/api/v1/user/liked-videos`, {
    ...
    <div className="max-w-5xl mx-auto px-2 py-4">
      ...
      <div className="flex items-center gap-3 mb-6">
        <div className="w-12 h-12 rounded-full bg-red-100 flex items-center justify-center">
          <span className="material-symbols-outlined text-red-500 text-2xl">thumb_up</span>
        </div>
        <div>
      ...
      {videos.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 gap-3 text-gray-400">
          <span className="material-symbols-outlined text-6xl">thumb_up</span>
          <p className="text-base font-medium">No liked videos yet</p>
